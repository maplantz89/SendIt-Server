...
climbsRouter
  ...
  .post(bodyParser, (req, res, next) => {
    const { user_id } = req.params;
    const { attempts, date, location, video, favorite, difficulty} = req.body;
    const newClimb = { user_id, attempts, date, location, video, favorite, difficulty };
    const requiredFields = { attempts, location, difficulty};
...
climbsRouter
  ...
  .patch(bodyParser, (req, res, next) => {
    ...
    const { attempts, date, location, video, favorite, difficulty} = req.body;
    const updatedClimb = { attempts, date, location, video, favorite, difficulty };  
